...
public class NoticeService {
     ...
     * ADMIN: Post a notice
     */
    public static boolean postNotice(int classroomId, String title, String content,
                                     String category, int createdBy) {
        String sql = "INSERT INTO notice (classroom_id, title, content, category, created_by, created_at) " +
    ...
    public static List<Notice> getNoticesByCategory(int classroomId, String category) {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            System.err.println("Error fetching notices by category: " + e.getMessage());
        }
    ...
    public static boolean togglePin(int noticeId, boolean pin) {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            System.err.println("Error toggling pin: " + e.getMessage());
            return false;
        }
    }
