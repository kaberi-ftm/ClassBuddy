...
public class AdminClassroomManagementController {
    ...
    private void loadRoutineManagement() {
        ...
        addBtn.setStyle("-fx-background-color: #3498db; -fx-text-fill: white; -fx-padding: 10 20;");
    ...
    private HBox createRoutineCard(Routine routine) {
        ...
        card.setStyle("-fx-padding: 10; -fx-border-color: #ddd; -fx-border-width: 1; -fx-background-color: white;");
    ...
    private void loadExamManagement() {
        ...
        addBtn.setStyle("-fx-background-color: #f39c12; -fx-text-fill: white; -fx-padding: 10 20;");
    ...
    private void loadLabTestManagement() {
        ...
        addBtn.setStyle("-fx-background-color: #9b59b6; -fx-text-fill: white; -fx-padding: 10 20;");
    ...
    private void loadNoticeManagement() {
        ...
        addBtn.setStyle("-fx-background-color: #27ae60; -fx-text-fill: white; -fx-padding: 10 20;");
    ...
    private VBox createNoticeCard(Notice notice) {
        ...
        Label title = new Label((notice.isPinned() ? "📌 " : "") + notice.getTitle());
